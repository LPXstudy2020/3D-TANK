...
public:
	...
	virtual DirectX::BoundingBox GetLocalBoundingBox() const;
	virtual DirectX::BoundingBox GetBoundingBox() const;
	virtual DirectX::BoundingOrientedBox GetBoundingOrientedBox() const;
	//碰撞检测
